...
const CResult::ListCResult &CResult::getArry( void ) const
{
    if ( _type != REDIS_REPLY_ARRAY )
    {
        LOG_ERROR( "Data is not arry type" );
    }
    return _arry;
}

SInt64 CResult::getInt(void) const
{
    if ( _type != REDIS_REPLY_INTEGERER )
    {
         LOG_ERROR( "Data is not int type" );
    }
...
string CResult::getString( void ) const
{
    ...
    {
        LOG_ERROR( "Data is not string type" );
    }
    return *this;
}
...
string CResult::getErrorString( void ) const
{
    ...
    {
         LOG_ERROR( "Data is not error type" );
    }
    return *this;
}
