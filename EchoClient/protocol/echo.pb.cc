...
void protobuf_AssignDesc_echo_2eproto() {
  ...
  static const int EchoRequest_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EchoRequest, name_),
...
void protobuf_AddDesc_echo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\necho.proto\022\003App\"(\n\013EchoRequest\022\014\n\004name"
    "\030\002 \001(\t\022\013\n\003msg\030\003 \001(\t", 59);
...
EchoRequest::EchoRequest()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:App.EchoRequest)
}
...
EchoRequest::EchoRequest(const EchoRequest& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:App.EchoRequest)
}
...
EchoRequest::~EchoRequest() {
  // @@protoc_insertion_point(destructor:App.EchoRequest)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:App.EchoRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:App.EchoRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:App.EchoRequest)
  return false;
#undef DO_
}
...
void EchoRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:App.EchoRequest)
  // optional string name = 2;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:App.EchoRequest)
}

::google::protobuf::uint8* EchoRequest::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:App.EchoRequest)
  // optional string name = 2;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:App.EchoRequest)
  return target;
}
