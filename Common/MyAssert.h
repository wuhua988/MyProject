...
void SetAssertLogger(AssertLogger* theLogger);
    ...
    #define Assert(condition)    {                              \
        ...
        {                                                       \
            ...
            os_snprintf (s,kAssertBuffSize -1, "_Assert: %s, %d",__FILE__, __LINE__ ); \
            MyAssert(s);                                        \
        }   }
    ...
    #define AssertV(condition,errNo)    {                                   \
        ...
        {                                                                   \
            char s[kAssertBuffSize];                                        \
            s[kAssertBuffSize -1] = 0;                                      \
            os_snprintf( s,kAssertBuffSize -1, "_AssertV: %s, %d (%d)",__FILE__, __LINE__, errNo );    \
            MyAssert(s);                                                    \
        }   }
